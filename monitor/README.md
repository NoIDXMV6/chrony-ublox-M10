...
13. [Благодарности](#Благодарности)
...
### Схема подключения  
<img width="351" height="240" alt="591172794-20aa2bcb-661e-4055-ad2e-36ef8ed80423" src="https://github.com/user-attachments/assets/b7d78d06-d020-4849-97ba-6567593cb95d" />
...
Этот проект использует идеи и наработки из следующих открытых проектов:

*   **[TICC-DASH](https://github.com/anoniemerd/ticc-dash)** (автор: anoniemerd) — вдохновение для расширенной панели клиентов NTP, включая статус‑индикаторы и парсинг вывода `chronyc clients`. TICC-DASH — это современный веб‑интерфейс для мониторинга клиентов Chrony NTP, построенный на Python (Flask) и Bootstrap 5.
*   **[gpsd](https://gpsd.io/)** (команда GPSD) — алгоритм и концепция **skyview** (полярная проекция спутников) были адаптированы из скрипта `skyview.php` в contrib‑репозитории gpsd. Этот скрипт используется для генерации изображений небесной сферы со спутниками и помогает оценить качество размещения антенны.

Мы благодарны сообществу разработчиков открытого ПО за эти ценные инструменты.
---
